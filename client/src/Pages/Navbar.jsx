    ...
    <nav className="w-full bg-primary px-5 pt-3 text-white md:px-16">
      <div className="container mx-auto mt-0 flex w-full flex-wrap items-center justify-between py-2">
        ...
        <div
          ...
          id="nav-content"
        >
          <ul className="mx-12 list-reset flex-1 items-center justify-end lg:flex">
            <li className="mr-5">
              <Link to={"/"}>
                <h2 className="inline-block cursor-pointer py-2 px-4 font-semibold text-black no-underline">
                  Home
                </h2>
              </Link>
            </li>
            <li className="mr-5">
              <h2  className="hover:text-underline inline-block cursor-pointer py-2 px-4 font-semibold text-black no-underline hover:text-gray-800">
                <a href="#abt">About</a>
              </h2>
            </li>
          </ul>
